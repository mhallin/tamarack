...
sablono.util.ToString = (function (){var obj8462 = {};return obj8462;
})();
...
sablono.util.ToURI = (function (){var obj8464 = {};return obj8464;
})();
...
as_str.cljs$lang$applyTo = (function (arglist__8465){
var xs = cljs.core.seq(arglist__8465);
...
{var vec__8467 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);var first_word = cljs.core.nth.call(null,vec__8467,0,null);var words = cljs.core.nthnext.call(null,vec__8467,1);if((cljs.core.empty_QMARK_.call(null,words)) || (cljs.core._EQ_.call(null,"aria",first_word)) || (cljs.core._EQ_.call(null,"data",first_word)))
{return k;
} else
...
var merge_with_class__delegate = function (maps){var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__8468_SHARP_){if(cljs.core.list_QMARK_.call(null,p1__8468_SHARP_))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__8468_SHARP_], null);
} else
{if(cljs.core.sequential_QMARK_.call(null,p1__8468_SHARP_))
{return p1__8468_SHARP_;
} else
...
merge_with_class.cljs$lang$applyTo = (function (arglist__8469){
var maps = cljs.core.seq(arglist__8469);
...
* CSS classes.
*/
sablono.util.match_tag = (function match_tag(s){var matches = cljs.core.re_seq.call(null,/[#.]?[^#.]+/,cljs.core.name.call(null,s));var vec__8473 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,("Can't match CSS tag: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",1014018828),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):((new cljs.core.Keyword(null,"default","default",2558708147))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null):null)));var tag_name = cljs.core.nth.call(null,vec__8473,0,null);var names = cljs.core.nth.call(null,vec__8473,1,null);return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__8473,tag_name,names){
return (function (p1__8470_SHARP_){return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__8470_SHARP_));
});})(matches,vec__8473,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__8473,tag_name,names){
return (function (p1__8471_SHARP_){return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__8471_SHARP_));
});})(matches,vec__8473,tag_name,names))
,names)))], null);
});
/**
...
*/
sablono.util.normalize_element = (function normalize_element(p__8474){var vec__8477 = p__8474;var tag = cljs.core.nth.call(null,vec__8477,0,null);var content = cljs.core.nthnext.call(null,vec__8477,1);if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
...
{}
var vec__8478 = sablono.util.match_tag.call(null,tag);var tag__$1 = cljs.core.nth.call(null,vec__8478,0,null);var id = cljs.core.nth.call(null,vec__8478,1,null);var class$ = cljs.core.nth.call(null,vec__8478,2,null);var tag_attrs = sablono.util.compact_map.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",1013907597),id,new cljs.core.Keyword(null,"class","class",1108647146),class$], null));var map_attrs = cljs.core.first.call(null,content);if(cljs.core.map_QMARK_.call(null,map_attrs))
