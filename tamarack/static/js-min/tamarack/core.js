...
tamarack.core.on_navigate = (function on_navigate(e){return tamarack.state.merge_state_BANG_(secretary.core.dispatch_BANG_(e.token));
});
...
tamarack.core.main = (function main(){tamarack.state.init_state();
jQuery("#date-dropdown").on("click",(function (p1__10433_SHARP_){return p1__10433_SHARP_.stopPropagation();
}));
...
tamarack.core.init_history();
return tamarack.view.render_all();
});
